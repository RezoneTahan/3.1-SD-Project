...
<body>
	...
	<div class="tm_banner">
		<div class="tm_banner-text">MEET THE TEAM</div>
	</div>
	
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<img src="images/talha.jpg">
				<p>Name-->AMEER TALHA<br>ID-->180104036</p>
				
			</div>
			<div class="col-md-4">
				<img src="images/rezone.jpg">
				<p>Name-->SHEIKH MD REZONE ULLAH<br>ID-->180104037</p>
				
			</div>
			<div class="col-md-4">
				<img src="images/samin.jpg">
				<p>Name-->SAMIN UL ALAM<br>ID-->180104043</p>
